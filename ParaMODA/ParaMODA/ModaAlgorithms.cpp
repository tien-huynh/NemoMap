...
bool ModaAlgorithms::getUseModifiedGrochow()
{
	return UseModifiedGrochow;
}

void ModaAlgorithms::setUseModifiedGrochow(bool ModifiedGrochow)
{
	UseModifiedGrochow = ModifiedGrochow;
}
...
//{
//	return map<QueryGraph, string>();
//}
//
//map<QueryGraph, list<Mapping>> ModaAlgorithms::Algorithm1(UndirectedGraph<int> inputGraph, QueryGraph qGraph, int subgraphSize, int thresholdValue)
//{
//	return map<QueryGraph, list<Mapping>>();
//}
//
//list<Mapping> ModaAlgorithms::Algorithm2(QueryGraph queryGraph, UndirectedGraph<int> inputGraphClone, int numberOfSamples, bool getInducedMappingsOnly)
//{
//	return list<Mapping>();
//
...
//}
//
//list<Mapping> ModaAlgorithms::Algorithm2_Modified(QueryGraph queryGraph, UndirectedGraph<int> inputGraph, int numberOfSamples, bool getInducedMappingsOnly)
//{
//	return list<Mapping>();
//}
...
ExpansionTreeNode ModaAlgorithms::GetNextNode()
{
	...
	//if (_builder->getVerticesSorted().size() > 0)
	//{
...
//list<Mapping> ModaAlgorithms::Algorithm3(map<QueryGraph, list<Mapping>> allMappings, UndirectedGraph<int> inputGraph, QueryGraph queryGraph, AdjacencyGraph<ExpansionTreeNode> expansionTree, QueryGraph parentQueryGraph, string & newFileName, string fileName)
//{
//	return list<Mapping>();
//}
